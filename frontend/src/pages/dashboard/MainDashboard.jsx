...
import { mockDataMainDashboard, mockDataUsers } from '../../data/mockData'
...
const MainDashboard = () => {
  ...
  return (
      ...
      >
        <DataGrid  disableColumnMenu  slots={{toolbar:CustomToolbar}} rows={mockDataMainDashboard} columns={columns}/>
      </Box>
  )
}
