...
const EmployeeList = () => {
  ...
  const handleSaveEdit = async () => {
    try {
      ...
      setEmployees(
        employees.map((c) =>
          c._id === editEmployeeData._id ? editEmployeeData : c
        )
      );
            ...
            <Box sx={{ padding: 3 }}>
              ...
              >
                ...
                <Box>
                  ...
                  <Typography>
                    {" "}
                    {selectedEmployee.username || "No Data"}
                  </Typography>
                  <Typography>
                    {" "}
                    {selectedEmployee.department || "No Data"}
                  </Typography>
                  <Typography>
                    {" "}
                    {selectedEmployee.postname || "No Data"}
                  </Typography>
                  <Typography>
                    {" "}
                    {selectedEmployee.email || "No Data"}
                  </Typography>
                  <Typography>
                    {" "}
                    {selectedEmployee.salary || "No Data"}
                  </Typography>
                  <Typography>
                    {" "}
                    {selectedEmployee.dateofjoining || "No Data"}
                  </Typography>
                  <Typography>
                    {" "}
                    {selectedEmployee.dateofleaving || "No Data"}
                  </Typography>
                  <Typography>
                    {selectedEmployee.mobile || "No Data"}
                  </Typography>
                  <Typography>
                    {" "}
                    {selectedEmployee.address || "No Data"}
                  </Typography>
                  <Typography> {selectedEmployee.role || "No Data"}</Typography>
                  <Typography>
                    {" "}
                    {selectedEmployee.status || "No Data"}
                  </Typography>
                </Box>
              </Box>
            </Box>
