...
const CustomerGroup = () => {
      ...
      renderCell: (params) => (
        ...
        >
          <IconButton
            ...
            onClick={() => handleViewCustomers(params.row.id)}
          >
            <Visibility />
          </IconButton>
          <IconButton
  ...
  startIcon={<Add />}
  sx={{
    bgcolor: colors.blueHighlight[700],
    color: "white",
    m: 1.5,
    boxShadow: 2,
    ...
    "&:hover": {
      bgcolor: colors.blueHighlight[600], // Slightly lighter shade on hover
      transform: "scale(1.01)", // Slight scale-up effect
      boxShadow: `0 4px 12px ${colors.blueHighlight[900]}80`, // Glow effect with transparency
    },
  }}
      ...
      >
        ...
        >
          <Typography variant="h6">
            List of Customers in {currentGroupName}
          </Typography>
          <Box
            sx={{
              height: "200px",
            ...
            >
              {customers.map((customer) => (
                <div key={customer._id}>
                  ...
                  />
                  <label htmlFor={`customer-${customer._id}`}>
