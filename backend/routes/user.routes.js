...
import { fetchCompaniesByEmail, createUser, deleteUser, getAllUsers, getMuteUsers, getUser, loginUser, registerUser, updateUser, updateUserImage, updateUserRole } from '../controllers/user.controller.js';
...
router.route('/companies').post(fetchCompaniesByEmail);
